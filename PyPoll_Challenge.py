...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        # If the county does not match any existing county in the county list add it to the county list.
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (cvotes > winning_count) and (cvote_percentage > largest_county_percentage):
